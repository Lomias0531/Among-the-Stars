...
public class main : MonoBehaviour
{
    ...
    void InitTestDatas()
    {
        ...
        Config.Instance.rule = new GenerateRule();
        Config.Instance.rule.generateRule = new Dictionary<string, int>();
        ...
        Config.Instance.rule.generateRule.Add("棕矮星", 8);
        Config.Instance.rule.generateRule.Add("黄矮星", 5);
